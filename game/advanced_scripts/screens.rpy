...
style poemgame_text:
    ...
    hover_xoffset -3
    hover_outlines [(3, "#f5ddff", 0, 0), (2, "#efc9ff", 0, 0), (1, "#e4a5ff", 0, 0)]
...
style frame:
    ...
    background Frame("gui/misc/frame.png", gui.frame_borders, tile=gui.frame_tile)
...
style window:
    ...
    background Image("gui/misc/textbox.png", xalign=0.5, yalign=1.0)
...
style namebox:
    ...
    background Frame("gui/misc/namebox.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign)
...
style say_label:
    ...
    yalign 0.5
    outlines [(3, "#9b53ba", 0, 0), (1, "#9b53ba", 1, 1)]
        ...
        if not persistent.autoload or not main_menu:
            ...
            if main_menu:
                ...
                if persistent.playthrough == 1:
                    ...
                    textbutton _("Новая игра") action If(persistent.playername, true=Start(), false=Show(screen="name_input", message="Please enter your name", ok_action=Function(FinishEnterName)))
            ...
            if _in_replay:
                ...
                textbutton _("Остоновить реплей") action EndReplay(confirm=True)
...
style navigation_button_text:
    ...
    font "gui/font/Ubuntu-Bold.ttf"
    color "#fff"
    outlines [(4, "#9b53ba", 0, 0), (2, "#9b53ba", 2, 2)]
    hover_outlines [(4, "#e5aaff", 0, 0), (2, "#e5aaff", 2, 2)]
    insensitive_outlines [(4, "#efccff", 0, 0), (2, "#efccff", 2, 2)]
...
style game_menu_outer_frame:
    ...
    background "gui/menu/game_menu_bg.png"
...
style game_menu_label_text:
    ...
    size gui.title_text_size
    color "#fff"
    outlines [(6, "#9b53ba", 0, 0), (3, "#9b53ba", 2, 2)]
    yalign 0.5
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton "English" text_font "gui/font/Ubuntu-Regular.ttf" action Language("english")
                    textbutton "Русский" text_font "gui/font/Ubuntu-Regular.ttf" action Language(None)
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Время до авто-пролистывания")
...
style confirm_frame:
    background Frame([ "gui/confirm_frame.png", "gui/misc/frame.png"], gui.confirm_frame_borders, tile=gui.frame_tile)
