label mainscript:
  ...
  y "Я твой туберкулёз. Назойливая — ни за что не избавиться, я тот маленький капризный узел под твоей тонкой ключицей, что поселился там плотным комочком навсегда и с каждым вдохом неумолимо разрастается. "
  y "Всё, что мешает тебе жить, это я, я заполняю твои лёгкие до предела. Такой до беспамятства влюбленный нарыв на прекрасном бархатном теле, до эгоизма впившийся острыми когтями в твою мягкую плоть, до боли, до кровохарканья."
  ...
  "Я решил обнять её."
  scene y_hug with dissolve_scene
