label mainscript:
  ...
  y "Я твой туберкулёз. "
  y "Назойливая — ни за что не избавиться." 
  y "Я тот маленький капризный узел под твоей тонкой ключицей, что поселился там плотным комочком навсегда."
  y "И с каждым вдохом неумолимо разрастается. "
  y "Всё, что мешает тебе жить, это я, я заполняю твои лёгкие до предела."
  y "Такой до беспамятства влюбленный нарыв на прекрасном бархатном теле, до эгоизма впившийся острыми когтями в твою мягкую плоть."
  y "До боли, до кровохарканья."
